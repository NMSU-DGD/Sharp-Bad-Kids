...
public class scr_Selector : MonoBehaviour {
    ...
    private int headType = 0; // which head type A or B? 0/1
    private int headSkinTone = 0; // the headchoice will be remembered for hair tones
    ...
    void pickHead()
    {
                ...
                headSkinTone = pick; // remeber this for decigning hairs
                count = 0;
